# eCommerce Cross-selling using Outside-In TDD approach

## Goal

Implement ecommerce using  Outside-In TDD approach and without waiting for the necessary services to be available.
